...
- @PostMapping: anotación en Spring que se utiliza para mapear solicitudes HTTP POST a métodos específicos en un controlador.
- @GetMapping: anotación en Spring que se utiliza para mapear solicitudes HTTP GET a métodos específicos en un controlador.
